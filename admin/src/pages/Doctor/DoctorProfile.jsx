...
const DoctorProfile = () => {
  const {getProfileData,profileData,dToken,setProfileData,backendUrl} = useContext(DoctorContext);
       ...
       <div className='flex flex-col gap-4 m-5'>
         ...
         <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
           ...
           <div className='flex items-center gap-2 mt-1 text-gray-600'>
            ...
            <p className='text-gray-600 font-medium mt-4'>Appointment fee : <span className='text-gray-800'>{currency} { isEdit ? <input type='number' value = {profileData.fees} onChange={(e)=>setProfileData(prev=>({...profileData,fees:e.target.value}))}/> : profileData.fees}</span></p>
            <div>
